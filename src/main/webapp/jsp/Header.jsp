<%@page import="com.controller.LoginCtl"%>
<%@page import="com.controller.ATBView"%>
...
<title>Insert title here</title>
 <link rel="stylesheet" href="/FlyAway/css/bootstrap.min.css">
  <script src="/FlyAway/js/jquery.min.js"></script>
  <script src="/FlyAway/js/bootstrap.min.js"></script>
...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    <div class="navbar-header">
      <a class="navbar-brand" href="<%=ATBView.WELCOME_CTL%>">FlyAway Booking Portal</a>
    </div>
